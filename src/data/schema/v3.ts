// Blacksite Data Workbench — schema v3 (embedded for runtime bundling).
// Keep this DDL identical to v3.sql.

export const V3_SCHEMA = `-- Blacksite Data Workbench — schema v3
