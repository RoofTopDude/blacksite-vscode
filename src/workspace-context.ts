...
export function buildStaticSystemPrompt(): string {
  ...
  parts.push(
    ...
    "- **Execution Runs:** use sequence_discover before broad browser coverage, sequence_execute for bounded repeatable multi-step evidence, and sequence_inspect to seek into retained observations without rerunning. sequence_compare reports candidate differences, not automatic defects. Link runs to an approved plan phase or ticket when they are evidence for tracked work. Remote/external mutations and destructive automation remain outside retained-sequence scope.",
