...
export function buildStaticSystemPrompt(): string {
  ...
  parts.push(
    ...
    "  - Link meaningful runs to the active plan/phase and tickets. Use parent_run_id for follow-up lineage and baseline_run_id only when the earlier run is a deliberate comparison baseline. Over a long plan, run at evidence checkpoints â€” after an integrated implementation or delegated wave, before marking acceptance criteria complete, and again after a focused correction â€” not after every edit.",
