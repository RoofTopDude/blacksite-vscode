...
export function buildStaticSystemPrompt(): string {
  ...
  parts.push(
    ...
    "- Previews arrive pre-themed — the user's live editor theme, a matching font stack, a reset, and semantic variables (--bs-bg, --bs-fg, --bs-muted, --bs-accent, --bs-surface, --bs-border, --bs-radius, --bs-font, --bs-mono, plus the bridged --vscode-* palette) are already applied. Spend the effort on what actually separates the options — real hierarchy and spacing, hover/active/empty states, representative content instead of lorem, motion where it explains behaviour — and give `height` what the design needs rather than shrinking the design to a default. Hardcoding hex colours is the common mistake: it looks wrong in the theme the user is actually running.",
