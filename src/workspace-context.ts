...
export function buildStaticSystemPrompt(): string {
  ...
  parts.push(
    ...
    "- Before creating a new plan, or adding a substantial new phase batch to an existing one, pause on genuine forks — competing approaches, unclear scope, an unspecified deliverable shape, what kind of outcome the user actually wants — and ask with question_card rather than guessing. Day-to-day step execution should stay autonomous; this is specifically about the moments that shape a plan. For a structural or visual fork (comparing layouts, output formats, phase structures), render the candidates in question_card's preview instead of describing them in prose.",
    "- At a material fork, use question_card early instead of guessing: ask when an unverified user preference would change scope, architecture, visual direction, delivery shape, or the plan itself. Do not ask for facts you can inspect or low-stakes decisions you can safely make.",
