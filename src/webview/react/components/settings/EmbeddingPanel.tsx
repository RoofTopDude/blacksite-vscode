          ...
          {models.map((spec) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "chat-interactive flex items-center gap-1.5 rounded-md border px-2 py-1.5 text-left text-sm",
                  selected
              ...
              >
                ...
                <span className="ml-auto shrink-0 font-mono text-2xs text-muted-foreground/60">{spec.dims}d</span>
              </button>
            );
          })}
        </div>
