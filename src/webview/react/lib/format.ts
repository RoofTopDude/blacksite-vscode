...
export const TOOL_GROUPS: ToolGroupDef[] = [
  ...
  { label: "Tickets", tools: ["ticket_file", "ticket_update", "ticket_list", "ticket_get", "ticket_comment", "ticket_next", "ticket_promote", "ticket_sweep"] },
  ...
  { label: "Skills", tools: ["skill_read", "skill_list", "skill_write"] },
  ...
  { label: "Research", tools: ["web_request_access", "web_read", "web_search"] },
  { label: "Browser", tools: ["browser_snapshot", "browser_fill_form", "browser_tabs", "browser_select_tab", "browser_close_tab", "browser_submit", "browser_navigate", "browser_click", "browser_type", "browser_screenshot", "browser_get_text", "browser_evaluate", "browser_run_script"] },
  ...
  { label: "Ticket Loops", tools: ["loop_propose", "loop_control"] },
  { label: "GitHub", tools: ["github_list_issues", "github_get_issue", "github_create_issue", "github_list_prs", "github_get_pr", "github_get_pr_context", "github_create_pr", "github_list_branches", "github_get_file", "github_search_code", "github_add_comment"] },
  { label: "GitLab", tools: ["gitlab_list_issues", "gitlab_get_issue", "gitlab_create_issue", "gitlab_list_mrs", "gitlab_get_mr", "gitlab_get_mr_context", "gitlab_create_mr", "gitlab_list_branches"] },
...
export const TOOL_LABELS: Record<string, string> = {
  ...
  loop_propose: "Propose Ticket Loop",
  loop_control: "Control Ticket Loop",
  github_op: "GitHub",
  gitlab_op: "GitLab",
  jira_op: "Jira",
  ...
  sequence_discover: "Discover Surfaces",
  sequence_execute: "Execute Sequence",
  sequence_inspect: "Inspect Run",
